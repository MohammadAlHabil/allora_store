...
export default function CartPage() {
  ...
  // Loading state - show skeleton that mirrors cart layout
      ...
      <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted/30">
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-2xl mx-auto">
            ...
            <Card className="border-2 border-dashed shadow-none  duration-300">
              <CardContent className="pt-16 pb-16 px-8">
                <div className="flex flex-col items-center justify-center text-center space-y-6">
                  ...
                  <Link href="/">
                    <Button
                      size="lg"
                      className="mt-6 h-12 px-8 text-base font-semibold shadow-none hover:shadow-none transition-all duration-200 hover:scale-105"
                    >
                      Start Shopping
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-4">
              <Card className="border shadow-none transition-all duration-200 hover:scale-[1.02] bg-card/50 backdrop-blur-sm">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-8 space-y-4 animate-in fade-in slide-in-from-top-4 duration-500">
            <div className="flex items-center justify-between flex-wrap gap-4">
              ...
              <Badge variant="secondary" className="px-3 py-1 text-sm font-semibold shadow-none">
          ...
          <div className="grid gap-6 lg:gap-8 lg:grid-cols-[1fr_420px]">
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-left-4 duration-500">
              <Card className="shadow-none border bg-card/80 backdrop-blur-sm  duration-300 pt-0">
                <CardHeader className="border-b bg-gradient-to-r from-primary/5 via-primary/5 to-transparent pt-6">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline" className="font-semibold shadow-none">
              ...
              <div className="flex flex-wrap justify-center gap-3 md:gap-4">
                <Card className="flex-1 min-w-[140px] max-w-[200px] border shadow-none  transition-all duration-200 hover:scale-[1.02] bg-gradient-to-br from-primary/5 via-primary/5 to-transparent">
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
              ...
              {/* Cart Summary */}
              <Card className="shadow-none border-2 border-primary/10 sticky top-4 bg-card/90 backdrop-blur-sm  duration-300 pt-0">
                <CardHeader className="border-b bg-gradient-to-r from-primary/5 via-primary/5 to-transparent pt-6">
